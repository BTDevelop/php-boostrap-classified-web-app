                        ...
                        <thead>
                            <tr>
                                <th class="auto-style1">
                                    <asp:CheckBox ID="CheckBox2" runat="server" OnCheckedChanged="cbTumu_CheckedChanged" AutoPostBack="true" />
                                    <input type="hidden" name="name" value="<%#Eval("KategoriId") %>" />
                                </th>
                                <th class="auto-style1">Categories
                                </th>
                                <th class="auto-style1">Article Count
                                </th>
                                ...
                                <ItemTemplate>
                                    <tr class="odd gradeX">
                                        <td>
                                            ...
                                            <asp:HiddenField ID="hfGizli" runat="server" Value='<%#Eval("KategoriId") %>' />
                                        </td>
                                        <td>
                                            <%#Eval("KategoriAd") %>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("KategoriId","~/Management/Kategori/Default2.aspx?sayfaGetir=Update&KategoriId={0}") %>'>Update</asp:HyperLink>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
